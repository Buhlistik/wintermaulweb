...
function connect(baseUrl,session,version='0.98.0'){
    return new Promise((resolve,reject)=>{
...
(async()=>{
    ...
    try{
        ...
        assert.deepEqual(await healthResponse.json(),{ok:true,protocolVersion:'0.98.0',rooms:0,players:0});
        ...
        assert.equal(mismatch.requiredVersion,'0.98.0');await outdated.close();
        ...
        assert.equal(hostWelcome.protocolVersion,'0.98.0');
