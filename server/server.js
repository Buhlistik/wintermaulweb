...
function gameState(client,payload){
    ...
    const attackModes=new Set(['projectile','meteor','sky-strike','beam-strike','radial','wave','ring','boomerang','breath']);
    ...
    const attackShapes={projectile:'circle',meteor:'circle','sky-strike':'circle','beam-strike':'circle',radial:'segment',wave:'expanding-ring',ring:'expanding-ring',boomerang:'swept-circle',breath:'cone'};
